...
.input-borders{
    border-radius:30px;
            ...
            <form id="signup_form"  class="login100-form" role="form" method="post" action=" ">
              <div class="billing-details jumbotron">
                              ...
                              <ul>
                                <li><a href="login-doctor.php" class="bt"><span class="d-none d-md-inline"></span>Doctor Login</a></li>
  ...
  if (isset($_POST["email"]) && isset($_POST["password"])) {
  	...
  	$sql = "SELECT * FROM info_user WHERE email = '$email' AND password = '$password'";
  	...
  	if ($count == 1) {
  			...
  			$BackToMyPage = $_SERVER['HTTP_REFERER'];
  				if (!isset($BackToMyPage)) {
  					...
  					header('Location: user-index.php'); // default page
  				}
              exit;
  		} else {
